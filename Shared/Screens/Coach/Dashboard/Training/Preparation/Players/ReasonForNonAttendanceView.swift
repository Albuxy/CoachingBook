    ...
    var body: some View {
        ZStack {
            GeometryReader { _ in
                VStack(spacing: 50){
                    VStack(spacing: 20){
                        Text("non_attendance_reason_title".localized(LocalizationService.shared.language))
                            .foregroundColor(.black)
                            .font(.system(size: 24))
                            .bold()
                            .frame(width: UIScreen.main.bounds.width / 1.28, alignment: .leading)
                        Text("non_attendance_reason_subtitle".localized(LocalizationService.shared.language))
                            .font(.system(size: 18))
                            .foregroundColor(.black)
