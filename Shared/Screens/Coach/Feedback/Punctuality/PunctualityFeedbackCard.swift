    ...
    var body: some View {
        VStack(spacing: 15){
            ...
            VStack(alignment: .center, spacing: 15){
                MiniTrainingSessionGivePuncCard(currentTrainingSession: trainingData[0])
                MiniMatchSessionGivePuncCard(currentMatchSession: matchData[0])
                MiniTrainingSessionGivePuncCard(currentTrainingSession: trainingData[1])
            }
        }
